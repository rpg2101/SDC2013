    ...
    ; ¸ Francisco Charte 
	;
    ; Esta versi¢n detecta el arranque de Windows
    ; y lo impide, mostrando un mensaje de aviso
    ; por pantalla.
...
MensajeWindows  Db "Este programa no funciona bajo Windows,", 13, 10
                Db "ejecute TBLASCII /D y despu‚s cargue Windows.$"
...
Gestor2F Proc
    ...
    Cmp AX, 1605h       ; ¨Es el arranque de Windows?
    Je InicioWindows    ; en caso afirmativo saltar
...
InicioWindows:
    ...
    Push CS     ; DS:DX apuntando al mensaje
    Pop DS
    Mov DX, Offset MensajeWindows
    Mov AH, 9
    Int 21h     ; Imprimir el mensaje
    Mov CX, 1  ; y cancelar el arranque de Windows
    Iret ; devolviendo el control
