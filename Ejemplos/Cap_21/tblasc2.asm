	...
	;
    ; Esta versi¢n del programa detecta la VM
    ; en la que se produce la activaci¢n, de
    ; tal forma que al intentarse una segunda
    ; activaci¢n se conmute a dicha VM.
...
ActivarResidente Proc
    ...
    Cmp CS:[Activado], 1 ; Ver si el programa ya est  activo
    Jne ActivarNormalmente ; si no es as¡ proceder

        ; El programa ya est  activo en otra VM, por
        ; lo que es necesario conmutar el control a ella
...
ActivarNormalmente:
    ...
    Mov AX, 1683h   ; Obtener el identificador 
    Int 2Fh     ; de la VM en la que se activa
...
MsgInstalado Db "TBLASCII 1.0  ¸ 1996 Francisco Charte"
             Db 13, 10
